...
Download and unzip the AR-MOD SDK Framework from [github](https://github.com/Phantomxm2021/XRMOD-Framework).
...
- Create and write your app token to [PhantomsXRConfig.dart](https://github.com/Phantomxm2021/XRMOD-FlutterAppDemo/blob/main/lib/src/config/phantomsxrConfig.dart).
...
[Click here](https://github.com/Phantomxm2021/XRMOD-FlutterAppDemo) to download this source code!