...
<coverimg url={require('../../static/static/sdk/android-sdk/arcore-google.jpg')} height="25rem" />
...
Embedding XRMOD engine on the android platform does not need to change your original business and code, and only needs to call several APIs to complete the embedding.


<!--- android平台嵌入XRMOD engine无需更改您原本的业务和代码，仅需调用若干个API即可完成嵌入。--->
