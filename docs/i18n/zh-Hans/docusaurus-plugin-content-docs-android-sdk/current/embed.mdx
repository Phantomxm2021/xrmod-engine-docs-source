...
<coverimg url={require("@site/static/static/sdk/android-sdk/anddroid-studio-view.jpg")} height="25rem" />

## 下载 XRMOD AAR

增强您的应用程序的第一步是获得我们的 SDK！。
我们已经将 XRMOD 框架上传到 github。您可以[点击这里](https://github.com/Phantomxm2021/XRMOD-Framework)进入 github 页面并下载我们的 XRMOD AAR。如果您认为 XRMOD 不错，请给我们一颗星。谢谢！
