...
从[github](https://github.com/Phantomxm2021/XRMOD-Framework)下载并解压 AR-MOD SDK 框架。
...
- 创建并写入您的应用程序令牌到[PhantomsXRConfig.dart](https://github.com/Phantomxm2021/XRMOD-FlutterAppDemo/blob/main/lib/src/config/phantomsxrConfig.dart)。
- 并为 AR-MOD 写一个新的屏幕。
...
[点击这里](https://github.com/Phantomxm2021/XRMOD-FlutterAppDemo)下载这个源代码!
