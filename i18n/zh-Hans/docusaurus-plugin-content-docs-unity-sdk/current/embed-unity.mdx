...
从那时起，我们的AR-APP已经完成了。使用XRMOD引擎为我们节省了大量的时间，也为我们节省了如何与XR SDK互动的逻辑和知识。下一步是为它创建一个漂亮的UI/UX和XR体验。内容。如果你不知道如何制作内容，你可以[点击这里](.../experience-manual/tutorial-basics)来阅读。
